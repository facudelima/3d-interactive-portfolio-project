...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "facuudelimaa@gmail.com",
    href: "mailto:facuudelimaa@gmail.com",
    icon: <FaEnvelope height={"50px"} />,
  },
  {
    name: "Phone",
    content: "+598 98 190 799",
    href: "tel:8308509180",
    icon: <FaPhone height={"50px"} />,
  },
  {
    name: "LinkedIn",
    href: "https://uy.linkedin.com/in/facundo-de-lima-0baab7200",
    content: "/facundo-de-lima",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/facudelima",
    content: "/facudelima",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Facundo De Lima</p>
